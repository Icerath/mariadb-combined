...
import re
#annoying
from .html2text import LINE_LIMIT
from . import debug
...
TAG_RULES = {
    "p": paragraphTag, "h1": headerTag, "h2": headerTag, "h3": headerTag,
    "h4": headerTag, "h5": headerTag, "h6": headerTag, "code": codeTag,
    "pre": codeTag, "table": tableTag, "li": listTag
}